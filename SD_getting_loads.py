...
def cleance_load_dct(dct):
    keys_list = ['number', 'pickup', 'delivery', 'customer', 'payments', 'vehicles', 'driver'] #,  'terminals', 'online_bol_url', 'guid', 'status', 'stage'
    ...
    dct['delivery_csz'] = f"{dct['delivery']['state']} {dct['delivery']['zip']}"
    del dct['delivery']
